...
namespace AzureSamlSSO
{
    ...
    public class Reference
    {
        ...
        [SuppressMessage("Design", "CA1056:Las propiedades URI no deben ser cadenas", Justification = "Internal Library Use")]
    ...
    public class AzureResponse
    {
        ...
        // Stores if the request is valid or not
        public bool IsValid { get; set; }

        // Why The Request Isnt Valid
